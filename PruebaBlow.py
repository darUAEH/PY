...
"""
Blowfish Encryption
This module is a pure python2 implementation of Bruce Schneier's
...
if __name__ == '__main__':
    ...
    newKey = "sWdMGonC"
    keyCode = "00000000~GOMEZ FLORES LUIS ALFREDO~GOFL911110GZ1~1311910723-6~GOFL911110HHGMLS08~10630~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00~0000000.00"
    cl, cr = cipher.cipher (newKey, keyCode, cipher.ENCRYPT)
    print("\tCrypted is: (%s, %s)" %(cl, cr))
    dl, dr = cipher.cipher (cl, cr, cipher.DECRYPT)
    print("\tUnencrypted is: (%s, %s)" %(dl, dr))